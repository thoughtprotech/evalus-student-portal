	...
	return (
		<div className="space-y-4">
			<div
				...
				dangerouslySetInnerHTML={{ __html: html || "<p>No question text</p>" }}
			/>
			{options.length > 0 && (
...
// Future: export a getRenderer() by question.questionType to switch on types.
// export function getRenderer(question: QuestionPayload) { return DefaultQuestionRenderer; }
