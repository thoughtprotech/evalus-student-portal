...
import { createWriteUpAction } from "@/app/actions/admin/writeUps";
...
export default function NewWriteUpPage(){
  ...
  const save = async ()=>{
    ...
    setSaving(true);
    const res = await createWriteUpAction({ writeUpName:name.trim(), writeUp1: writeup, language, isActive: status, createdBy: username || 'Admin', modifiedBy: username || 'Admin', writeuptags: [] });
    setSaving(false);
  ...
  return <div className="p-4 bg-gray-50 h-full flex flex-col">
      ...
      <div className="max-w-6xl mx-auto bg-white shadow rounded-lg p-6 space-y-6">
        <div className="flex items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-gray-800">New WriteUp</h2>
          </div>
          <div className="flex items-center gap-3">
    ...
    <ConfirmationModal
      ...
      variant="success"
      title="WriteUp Created Successfully!"
      message="Your writeUp has been saved."
