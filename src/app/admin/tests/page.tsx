...
function TestsGrid({ query, onClearQuery }: { query: string; onClearQuery?: () => void }) {
  ...
  { field: "name", headerName: "Test Name", headerTooltip: "Test Name", sortable: true, filter: 'agTextColumnFilter', filterParams: { buttons: ['apply','reset','clear'] }, width: 300, cellRenderer: NameCellRenderer, tooltipField: "name", cellClass: 'no-left-border', headerClass: 'no-left-border' },
      { field: "startDate", headerName: "Start Date", headerTooltip: "Test Start Date", sortable: true, filter: 'agDateColumnFilter', filterParams: { buttons: ['apply','reset','clear'], browserDatePicker: true }, valueFormatter: ({ value }) => formatDate(value), width: 140 },
      { field: "endDate", headerName: "End Date", headerTooltip: "Test End Date", sortable: true, filter: 'agDateColumnFilter', filterParams: { buttons: ['apply','reset','clear'], browserDatePicker: true }, valueFormatter: ({ value }) => formatDate(value), width: 140 },
