...
import { createTestTypeAction } from "@/app/actions/admin/test-types";
...
export default function NewTestTypePage() {
    ...
    const submit = async () => {
        ...
        setSaving(true);
        const res = await createTestTypeAction({ type: type.trim(), language, isActive, createdBy: username || 'System', createdDate: nowIso, modifiedBy: username || 'System', modifiedDate: nowIso });
        setSaving(false);
        ...
        <div className="p-4 h-full flex flex-col">
            <div className="flex items-start justify-between w-[60%] mx-auto mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <PageHeader title="New Test Type" icon={<HelpCircle className="w-6 h-6 text-indigo-600" />} showSearch={false} onSearch={() => { }} />
                </div>
            ...
            <ConfirmationModal
                ...
                title="Test Type Created"
                message="Your test type has been created successfully."
