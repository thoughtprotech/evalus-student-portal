...
import { createTestCertificateAction } from "@/app/actions/admin/test-certificates";
import { fetchLanguagesAction } from "@/app/actions/dashboard/questions/fetchLanguages";
import { useUser } from "@/contexts/UserContext";
import type { GetLanguagesResponse } from "@/utils/api/types";

export default function NewTestCertificatePage() {
    ...
    const submit = async () => {
        ...
        const res = await createTestCertificateAction({
        ...
        <div className="p-4 h-full flex flex-col">
            <div className="flex items-start justify-between w-[60%] mx-auto mb-4">
                <div className="flex items-center gap-4">
                    ...
                    <PageHeader title="New Test Certificate" icon={<HelpCircle className="w-6 h-6 text-indigo-600" />} showSearch={false} onSearch={() => { }} />
                </div>
            ...
            <ConfirmationModal
                ...
                message="Your test certificate has been created successfully."
