...
import { createTestSectionAction } from "@/app/actions/admin/test-sections";
...
export default function NewTestSectionPage() {
  ...
  const submit = async () => {
    ...
    const res = await createTestSectionAction({
    ...
    <div className="p-4 h-full flex flex-col">
      <div className="flex items-start justify-between w-[60%] mx-auto mb-4">
        <div className="flex items-center gap-4">
          ...
          <PageHeader title="New Test Section" icon={<HelpCircle className="w-6 h-6 text-indigo-600" />} showSearch={false} onSearch={() => { }} />
        </div>
      ...
      <ConfirmationModal
        ...
        title="Test Section Created"
        message="Your test section has been created successfully."
