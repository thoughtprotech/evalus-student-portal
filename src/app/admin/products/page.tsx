      ...
      <div className="mb-3 flex items-center justify-between gap-3 flex-none">
        <div className="flex items-center gap-3 flex-wrap">
          <Link href="/admin/products/new">
            <button type="button" className="inline-flex items-center justify-center gap-2 w-32 px-3 py-2 rounded-md bg-blue-600 text-white text-sm shadow hover:bg-blue-700" title="Create new product">
        ...
        {rows.length === 0 && !loading ? (
          <div className="bg-white shadow rounded-md border border-gray-300 p-8 h-full overflow-auto">
            <div className="text-center">
              ...
              <Link href="/admin/products/new"><button className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-300">Add New Product</button></Link>
            </div>
          </div>
        ) : (
