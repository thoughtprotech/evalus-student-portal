...
export default function QuestionIndex({
  ...
  return (
    <div className="flex flex-col gap-2 bg-blue-400/20 h-full">
      <div className="items-center gap-2 bg-blue-600 w-full flex justify-center">
        <div>
          <h1 className="font-bold text-xl text-white">Questions Pallet</h1>
        </div>
      </div>
      <div className="grid grid-cols-8 md:grid-cols-4 gap-2 mb-4 px-2 h-fit">
